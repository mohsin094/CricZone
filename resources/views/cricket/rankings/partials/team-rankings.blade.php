                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <div class="flex items-center space-x-2">
                            <img src="{{ is_array($topTeam) ? ($topTeam['team_flag_url'] ?? '/images/default-flag.png') : ($topTeam->team_flag_url ?? '/images/default-flag.png') }}" alt="{{ is_array($topTeam) ? ($topTeam['team_name'] ?? 'Unknown Team') : ($topTeam->team_name ?? 'Unknown Team') }}" class="w-6 h-4 team-flag">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-2 py-1">
                                <div class="flex items-center">
                                    <img src="{{ is_array($ranking) ? ($ranking['team_flag_url'] ?? '/images/default-flag.png') : ($ranking->team_flag_url ?? '/images/default-flag.png') }}" alt="{{ is_array($ranking) ? ($ranking['team_name'] ?? 'Unknown Team') : ($ranking->team_name ?? 'Unknown Team') }}" class="w-5 h-3 team-flag mr-2">
